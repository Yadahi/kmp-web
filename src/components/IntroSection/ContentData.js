export const contentData = {
  intro: {
    ...
    description: `Našu komunitu tvoria rôznorodí ľudia s rôznymi vekmi, pohlaviami, povolaniami a osudmi. Veríme v dynamiku teamu a vieme, že raz zatiahne jeden, inokedy druhý, občas všetci naraz. Každý vie niečo a spolu vieme viac. Život je zmena a neustála transformácia, a tak to máme aj my v komunite. Radi cestujeme, spoznávame nové svety a vesmíri. Radi sa však i vraciame a organizujeme dobré veci pre seba či iných.`,
    ...
    logoDesc: `Naše logo vystihuje našu filozofiu. Všetko so všetkým súvisí, všetko je spolu previazané. Nedá sa starať o jednu vec bez toho, aby sme sa starali tú druhú. Toto logo nám pripravila skvelá grafička Katka Rybnická a vieme, že to celé vystihla. `,
  },
  introEnglish: {
    annotation: `Keď môžem pomôžem is a local NGO focused on social inclusion, ecology, sport and community.`,
